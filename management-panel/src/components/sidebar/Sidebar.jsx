    ...
    return  <nav className='sidebar'>
        <div className="sidebar__logo">
            <div className='sideLogo'>
                <img className="logo" src="https://lumiere-a.akamaihd.net/v1/images/open-uri20150422-20810-1baium2_5f280f6f.jpeg?region=0,0,600,600" alt=""></img>
            ...
            <button className="btn-close">
                    <img src="https://a.trellocdn.com/prgb/dist/images/workspace-navigation/chevron-left.58243262833f693f6101.svg" alt=""></img>
                </button>
